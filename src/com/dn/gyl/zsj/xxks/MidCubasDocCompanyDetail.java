...
/**
 * 表名MID_CUBASDOC_COMPANY           
 * @Filename: MidCubasDocCompanyDetail
 * @Description: 
 * @Version: 1.0
 * @History:<br>
 *<li>Author:jun</li>
 ...
 */
public class MidCubasDocCompanyDetail {
	private String CUBASDOCCOMPANYID ;
	  /**中间表主键*/
	...
	public String getCUBASDOCCOMPANYID() {
		return CUBASDOCCOMPANYID;
	}
	public void setCUBASDOCCOMPANYID(String cUBASDOCCOMPANYID) {
		CUBASDOCCOMPANYID = cUBASDOCCOMPANYID;
	}
