 ...
 * @Depiction: 供应商新增 action
 **/
public class GYSXZ_ACTION implements Action {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try {
            ...
            while (recordSet.next()) {
                ...
                /**客商名称*/
                im.getHead().setCUSTNAME(Util.null2String(recordSet.getString("gysmc")));
                /**客商编码为空*/
                im.getHead().setCUSTCODE(Util.null2String(recordSet.getString("gysbm")));
                /**客商简称*/
                im.getHead().setCUSTSHORTNAME(Util.null2String(recordSet.getString("gysmc")));
                /**客商类型 1 供应商*/
                ...
                for(String ssgs:ssgsArr){
                    ...
                    /**客商名称*/
                    /**客商名称*/
                    mid.setCUSTNAME(Util.null2String(recordSet.getString("gysmc")));
                    /**客商编码为空*/
                    mid.setCUSTCODE(Util.null2String(recordSet.getString("gysbm")));
                    /**客商简称*/
                    mid.setCUSTSHORTNAME(Util.null2String(recordSet.getString("gysmc")));
                    /**客商类型 1 供应商*/
                    mid.setCUSTPROP("1");
                    /**删除标识*/
                    mid.setDR("0");
                ...
                if(!"".equals(Util.null2String(recordSet.getString("zh")))){
                    ...
                    /**客商名称*/
                    /**客商名称*/
                    yhmid.setCUSTNAME(Util.null2String(recordSet.getString("gysmc")));
                    /**客商编码为空*/
                    yhmid.setCUSTCODE(Util.null2String(recordSet.getString("gysbm")));
                    /**客商简称*/
