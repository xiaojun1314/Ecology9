 ...
 */
public class MidCubasDocHeadModel {
	  /**中间表主键*/
	  ...
	  /**default 0, --删除标记 */
	  private String DR;
	  /**default 'N',  --是否DRP结点  例：一致为N*/
	  private String DRPNODEFLAG ;
	  /**default 'N',  --是否散户     例：一致为N*/
	  private String FREECUSTFLAG; 
	  /**default 'N',  --是否渠道成员 例：一致为N */
	  private String ISCONNFLAG;
	  /**default 'N',  --地区分类     例：093*/
