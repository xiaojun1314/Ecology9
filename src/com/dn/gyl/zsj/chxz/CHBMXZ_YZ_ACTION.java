...
import com.dn.example.EXAMPLE_01_ACTION;
 ...
 */
public class CHBMXZ_YZ_ACTION implements Action {
    private Log log = LogFactory.getLog(CHBMXZ_YZ_ACTION.class.getName());
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        try{
            ...
            while(recordSet.next()){
                ...
                /**自由项*/
                String zyx=StringHelper.null2String(recordSet.getString("zyx"));
                // 402880e85c108608015c1113fad601d3 是钢板入库 需要辅计量管控 辅单位不能为空 不管控
                if("402880e85c108608015c1113fad601d3".equals(sffwdrk)&&"1".equals(sffjlgl)){
                    returnMessage="该存货名称为:"+chmc+",规格为:"+gg+";已钢板入库,需要辅单位管控,请重新选择辅单位管控类型，重新提交!";
                    returnFlag=true;
                    break;
                }
